...
% C++, gui made using...  can do this and this

On the NAO, the script is interpreted, the text is being synthesized and the commands are being executed.

%C++, our own Script Engine

% The two pieces of software communicate using protobuf, this solution was being chosen becase..
